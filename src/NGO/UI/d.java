 ...
 * @author david
 */
public class d extends ContentPanelStructure {

    private InfDB idb;
    private ArrayList<HashMap<String,String>> dbVal;
    
    public d(User user, UIStructure parentPanel) {
    ...
    private void btnMyProjActionPerformed(java.awt.event.ActionEvent evt) {
