 ...
 * @author liam
 */
public class ProjectSettingsUIHand extends SettingsPanelFramework {

	InfDB idb;

	public ProjectSettingsUIHand(User user, String id) {
		super(user, id);
		...
		try {
			...
			setEditInfo();
			addLinkEditInfo("Project Manager", idNamnMap, idInput -> new SearchHandlaggareInfoPanel(user, idInput), förvaltNamn);
			addLinkEditInfo("Country", idNamnMap2, idInput -> new LandUI(user, idInput), förvaltNamn2);
